...
#城市列表接口
url_city = 'https://dianying.nuomi.com/common/city/citylist?hasLetter=false&isjson=false&channel=&client='
...
def get_detail(link, movieId, date, city_id, cinema_name):
    ...
    try:
        ...
        print(e)
        print(cinema_name, 'get info failed!!!')
    time.sleep(4)
